    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        const response = await getProductById(
          ...
          location?.latitude,
          location?.longitude,
          fromStore // Skip location check if from store
        );
    ...
    <div className="min-h-screen bg-white pb-24">
      ...
      <div className="pt-16">
        ...
        <div className="bg-white rounded-t-3xl -mt-6 relative z-10 px-4 md:px-6 lg:px-8 pt-2.5 md:pt-4 pb-2 md:pb-4">
          ...
          {/* Product name */}
          <h2 className="text-sm md:text-xl font-bold text-neutral-900 mb-0 leading-tight">
            {product.name}
          </h2>
                  ...
                  <div className="space-y-1">
                    {product.tags && product.tags.length > 0 && (
                      <div className="flex items-start">
                        <span className="text-[10px] font-semibold text-neutral-800 w-[180px] flex-shrink-0">
                          Key Features:
                        </span>
                        <span className="text-[10px] text-neutral-600">
            ...
            <div className="space-y-4">
              {reviews.map((review) => (
                <div
                  ...
                  <p className="text-xs text-neutral-600 leading-relaxed mb-1">
                    {review.comment}
                  </p>
