        ...
        <div className="pb-24 md:pb-8 bg-white min-h-screen">
            ...
            <div className="px-4 md:px-6 lg:px-8 py-6 max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-neutral-900 mb-2">SpeeUp</h2>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-neutral-700 leading-relaxed">
                        At SpeeUp, we're committed to revolutionizing the way you shop and receive your products.
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-neutral-700 leading-relaxed mb-4">
                        SpeeUp is a comprehensive e-commerce platform that connects customers with a wide range
                ...
                <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 text-sm">
                            ...
                            <span className="text-neutral-700">support@speeup.com</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-teal-600 flex-shrink-0">
                ...
                <div className="mt-8 text-center">
                    ...
                    <p className="text-xs text-neutral-500 mt-1">© 2024 SpeeUp. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
