...
export default function OrderDetail() {
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: `Track my SpeeUp order: Order #${
  ...
  const handleCancelOrder = async () => {
    ...
    try {
      ...
      console.log("Cancelling order:", id, "Reason:", cancellationReason);
  ...
  const handleSaveInstructions = () => {
    ...
    console.log("Saving instructions:", deliveryInstructions);
  ...
  const handleSaveSpecialRequests = () => {
    // TODO: Save to backend
    console.log("Saving special requests:", specialRequests);
      ...
      <div className="px-4 py-4 space-y-4 pb-24">
        ...
        <motion.div
          ...
          <div
            ...
            onClick={() => alert("Help & Support feature coming soon!")}
            style={{ cursor: "pointer" }}>
