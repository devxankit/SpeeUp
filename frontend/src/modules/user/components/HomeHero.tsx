...
const getIcon = (name: string) => {
  ...
  if (n.includes('fast-food') || n.includes('noodles')) {
    return (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18 8C19.6569 8 21 6.65685 21 5C21 3.34315 19.6569 2 18 2C16.3431 2 15 3.34315 15 5C15 6.65685 16.3431 8 18 8Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M2 14H22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M7 22H17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M5.5 14V22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M18.5 14V22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }

  if (n === 'pet' || n.includes('pet care')) {
    return (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M17 2.5C18.1046 2.5 19 3.39543 19 4.5C19 5.60457 18.1046 6.5 17 6.5C15.8954 6.5 15 5.60457 15 4.5C15 3.39543 15.8954 2.5 17 2.5Z" stroke="currentColor" strokeWidth="2" />
        <path d="M7 2.5C8.10457 2.5 9 3.39543 9 4.5C9 5.60457 8.10457 6.5 7 6.5C5.89543 6.5 5 5.60457 5 4.5C5 3.39543 5.89543 2.5 7 2.5Z" stroke="currentColor" strokeWidth="2" />
  ...
  if (n.includes('clean')) {
    return (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 12L21 2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M21 12H3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M3 12L21 22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      </svg>
    );
  }

  if (n.includes('bakery') || n.includes('cake')) {
    return (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M20 21H4V16H20V21Z" stroke="currentColor" strokeWidth="2" />
        <path d="M4 16V11C4 8.79086 5.79086 7 8 7H16C18.2091 7 20 8.79086 20 11V16" stroke="currentColor" strokeWidth="2" />
