...
export default function SellerLogin() {
  ...
  const handleMobileLogin = () => {
    if (mobileNumber.length === 10) {
      ...
      // For now, navigate to seller dashboard
      navigate('/seller');
    }
  };
  ...
  const handleEmailLogin = () => {
    if (email && password) {
      // Handle seller email login logic here
      // For now, navigate to seller dashboard
      navigate('/seller');
    }
  };
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-neutral-300 rounded-lg text-sm placeholder:text-neutral-400 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2.5 pr-10 border border-neutral-300 rounded-lg text-sm placeholder:text-neutral-400 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all"
                  />
                  <button
                    type="button"
