...
const SELLERS: Seller[] = [
  { id: '1', name: 'Chirag Seller' },
  { id: '2', name: 'Vaishnavi Seller' },
  { id: '3', name: 'Pratik Seller' },
];
...
const PRODUCTS: Product[] = [
  {
    ...
    image: '/assets/product-aashirvaad-atta.jpg',
    price: 55.00,
    marketPrice: 60.00,
    weight: '100g',
    discount: 8,
  ...
  },
  {
    id: '2',
    name: 'Maggi Masala 2 Minutes Instant Noodles',
    image: '/assets/product-act2-popcorn.jpg',
    price: 110.00,
    marketPrice: 120.00,
    weight: '200g',
    discount: 8
  },
  {
    ...
    image: '/assets/product-amul-butter.jpg',
    price: 1400.00,
    marketPrice: 1521.00,
    weight: '1 ltr',
    discount: 8
  },
  {
    id: '4',
    name: 'Conscious Food Desi A2 Ghee',
    image: '/assets/product-amul-cheese.jpg',
    price: 3000.00,
    marketPrice: 3200.00,
    weight: '2 ltr',
    discount: 8
...
export default function AdminPosOrders() {
  ...
  // Filter products based on selected seller
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === 'F1') {
        ...
        if (cart.length > 0) {
          ...
          alert('Cart is empty. Please add items to hold.');
        }
      } else if (e.key === 'F9') {
        e.preventDefault();
        handlePlaceOrder();
  ...
  }, [cart, selectedSeller, customerSearch, subtotal, tax, discountVal, additionalChargesTotal, total, paymentMethod]);
      ...
      <div className="flex flex-1 overflow-hidden p-4 gap-4">
        ...
        <div className="flex-1 flex flex-col bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden min-w-[300px]">
          ...
          <div className="p-4 border-b border-neutral-200">
            <h2 className="text-base font-medium text-neutral-700 mb-3">Products</h2>

            {/* Seller Selector and Search */}
            <div className="flex items-center gap-2">
              <select
                value={selectedSeller}
                onChange={(e) => setSelectedSeller(e.target.value)}
                className="px-3 py-2 border border-neutral-300 rounded text-sm bg-white focus:outline-none focus:border-green-500 flex-shrink-0"
              >
              ...
              <div className="relative flex-1">
                ...
                />
                <button
                  className="absolute right-0 top-0 bottom-0 px-3 bg-green-600 text-white rounded-r hover:bg-green-700"
                  disabled={!selectedSeller}
                >
          ...
          <div className="flex-1 overflow-y-auto p-4 bg-neutral-50">
            {!selectedSeller ? (
              <div className="h-full flex items-center justify-center text-neutral-400">
                <span className="text-sm">Please select a seller to view products</span>
              </div>
        ...
        <div className="w-full lg:w-[35%] xl:w-[400px] min-w-[320px] bg-white rounded-lg shadow-sm border border-neutral-200 flex flex-col h-full overflow-y-auto">
          ...
          <div className="flex-shrink-0 p-3 border-b border-neutral-200 flex justify-between items-center bg-white rounded-t-lg">
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1.5 rounded text-sm font-medium flex items-center gap-1 transition-colors"
            >
          ...
          <div className="flex-shrink-0 bg-neutral-50 p-4 border-t border-neutral-200">
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-neutral-100 border-none rounded text-sm focus:ring-1 focus:ring-green-500"
                  value={newChargeName}
                ...
                <button
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white p-2 rounded transition-colors flex-shrink-0"
                >
            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full text-white py-3 rounded text-sm font-medium flex justify-center items-center gap-2 shadow-sm transition-colors ${cart.length === 0
            ...
            <div className="flex justify-end mt-2">
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded text-sm font-medium transition-colors flex items-center gap-1"
              >
