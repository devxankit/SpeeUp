  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
          <div className="bg-teal-600 text-white px-4 sm:px-6 py-3">
            <h2 className="text-base sm:text-lg font-semibold">View Category</h2>
          </div>
                ...
                {displayedCategories.length === 0 ? (
                  ...
                  displayedCategories.map((category) => (
                    <tr key={category.id} className="hover:bg-neutral-50">
                      ...
                      <td className="px-4 sm:px-6 py-3 text-sm text-neutral-900">{category.totalSubcategory}</td>
                      <td className="px-4 sm:px-6 py-3 text-sm text-neutral-500">{category.groupCategory || '-'}</td>
                      <td className="px-4 sm:px-6 py-3">
                        <div className="flex items-center gap-2">
                          <button
