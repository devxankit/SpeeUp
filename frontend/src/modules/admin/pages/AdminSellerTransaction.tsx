  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-teal-600 px-4 sm:px-6 py-4 rounded-t-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        <h1 className="text-white text-xl sm:text-2xl font-semibold">View Seller List</h1>
          ...
          <table className="w-full min-w-[1400px]">
            ...
            <tbody className="bg-white divide-y divide-neutral-200">
              {displayedTransactions.length === 0 ? (
                <tr>
                  <td colSpan={10} className="px-4 sm:px-6 py-8 text-center text-sm text-neutral-500">
                ...
                displayedTransactions.map((transaction) => (
                  <tr key={transaction.id} className="hover:bg-neutral-50">
                    ...
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-900 font-medium">{transaction.sellerName}</td>
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-600">{transaction.orderId}</td>
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-600">{transaction.orderItemId}</td>
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-600">{transaction.productName}</td>
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-600">{transaction.variation}</td>
                    ...
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-900 font-medium">${transaction.amount.toFixed(2)}</td>
                    <td className="px-4 sm:px-6 py-3 text-sm text-neutral-600">{transaction.remark}</td>
