...
export default function AdminSystemUser() {
  ...
  const roles = ['Select role', 'Super Admin', 'Admin', 'Manager', 'Editor', 'Viewer'];
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="mt-4 flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-neutral-200">
                <div className="text-sm text-neutral-600">
                  Showing {displayedUsers.length > 0 ? startIndex + 1 : 0} to {Math.min(endIndex, sortedUsers.length)} of {sortedUsers.length} entries
                </div>
                <div className="flex items-center gap-2">
                  <button
